/*
  ...
  1. Changes
    - Remove all default pages from the database
...
DELETE FROM pages 
WHERE id IN (
  'aktivitetsrum', 'elbil', 'ellagarden', 'fargkoder', 'foreningsstamma', 
  'gastlagenhet', 'grillregler', 'skotselplan', 'sophantering', 
  'styrelse', 'styrelsemoten'
);
